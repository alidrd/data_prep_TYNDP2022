"""
This wasn't used in the end, because the dataset was old.
Instead, functions in the main script were modified to read the data directly from the original PECD as stored in inputs folder, e.g., read_ror_Infeed_data(weather_year, Node_list)
"""
...
# df_capaciteis_to_csv = df_capacities.copy()
